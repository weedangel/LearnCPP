...
#define NOTIFY_WATCH_ACTIVE_STATUS  0x001D
#define QUERY_WATCH_MOTION_INFO     0x001E
#define QUERY_WATCH_MOTION_DATA     0x001F
#define QUERY_WATCH_MOTION_RESULT   0x0020
...
#define WATCH_DEVCIE_MOTION_INFO_DATA   0x001E
#define WATCH_DEVCIE_MOTION_DATA        0x001F
#define WATCH_DEVCIE_MOTION_RESULT_DATA 0x0020
...
#define RECV_DATA_SUCCESS 0x00
#define RECV_DATA_FAIL    0x01


extern int one_complete_frame_check(unsigned char *data_buf, int data_len);
extern int process_recv_cmd_info(unsigned char *data_buf, int data_len);
